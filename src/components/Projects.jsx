          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-4">
                ...
                <a href={project.githubLink} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-blue-500 transition-colors">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
              <a href={project.githubLink} target="_blank" rel="noreferrer" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">{project.title}</a>
            </h3>
            ...
            <div className="flex flex-wrap gap-2 mt-auto">
              {project.techStack.map(tech => (
                <span key={tech} className="bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-800/30 px-3 py-1 rounded-full text-xs font-semibold">
                  {tech}
                </span>
              ))}
            </div>
