        ...
        {projectsData.map((project, index) => {
          ...
          return (
            <div 
              ...
              className="flex flex-col bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm hover:shadow-xl hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 fade-up opacity-0 translate-y-8 cursor-pointer group"
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                {/* The Links (e.stopPropagation prevents expanding the card when clicking a link) */}
