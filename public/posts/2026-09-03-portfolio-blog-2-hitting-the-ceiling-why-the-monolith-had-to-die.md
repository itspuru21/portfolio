...
In Blog 3, I will outline the architectural pivot: how I designed a database-less, GitOps-driven architecture that allows me to write in Markdown and let the code do the rest.
