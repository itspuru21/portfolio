...
With the concept of a static-dynamic hybrid architecture firmly in place ([see Blog 3](./portfolio-blog-3-pivot-to-gitops.md)), it was time to actually start writing code. 
...
The old setup was a flat directory containing exactly three files ([see Blog 1](./portfolio-blog-1-humble-beginnings.md)). That lack of organization is fine for a weekend project, but it is a disaster for a maintainable codebase. 
