...
With the visual shell and the basic interactivity now in place, the stage is set for the real technical heavy lifting. The UI is just an empty container. In [Blog 7](#/blog/2026-09-04-portfolio-blog-7-the-markdown-engine-rendering-content-without-a-server), I will dive into the core of the GitOps engine: how we actually fetch, parse, and inject raw Markdown files into these beautifully styled cards.