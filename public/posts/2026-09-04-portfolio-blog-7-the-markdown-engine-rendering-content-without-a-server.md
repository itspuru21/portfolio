...
date: "2026-09-04T13:51:27.407Z"
summary: "How I engineered a client-side Markdown parser to fetch, process, and render blog posts directly from the GitHub repository."
project: "Portfolio/Github Actions/Pages"
categories: ["CI/CD", "GitOps"]
---


In [Blog 6](#/blog/2026-09-04-portfolio-blog-6-the-interactive-static-ui-a-devops-approach-to-frontend), I established a lightweight, interactive frontend shell. But an empty shell isn't very useful. It was time to connect the UI to my "headless database" [as designed in Blog 3](#/blog/2026-09-03-portfolio-blog-3-the-pivot-to-gitops-designing-a-database-less-architecture). 
